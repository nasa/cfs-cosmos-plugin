...
class cfs_test_group_cfe_es(Group):
    ...
    def test_00_Aliveness(self):
        ...
        Group.print(f"Testing CFE_ES aliveness on <%= target_name %>")

        wait_check_packet(f"<%= target_name %>", "CFE_ES_HK", 1, 100)
    ...
    def test_10_QueryAllTasks(self):
        """
    ...
    def test_13_OverwriteSysLog_Discard(self):
        """
    ...
    def test_14_OverwriteSysLog_Overwrite(self):
        """
        Test the OverwriteSysLog command.
        """
        # Enable EVS events
    ...
    def test_17_StartPerfData(self):
        """
    ...
    def test_19_SetPerfFilterMask(self):
        """
    ...
    def test_20_SetPerfTriggerMask(self):
        """
    ...
    def test_22_SetMaxPRCount(self):
        """
    ...
    def test_25_DumpCDSRegistry(self):
        """
    ...
    def test_26_ResetCounters(self):
        """
